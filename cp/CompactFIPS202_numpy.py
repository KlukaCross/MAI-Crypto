...
def Keccak(rate, capacity, inputBytes, delimitedSuffix, outputByteLen, roundsNumber=24):
    ...
    while(inputOffset < len(inputBytes)):
        ...
        if (blockSize == rateInBytes):
            state = KeccakF1600(state, roundsNumber)
            blockSize = 0
...
def SHA3_256(inputBytes, roundsNumber):
    return Keccak(1088, 512, inputBytes, 0x06, 256//8, roundsNumber)
